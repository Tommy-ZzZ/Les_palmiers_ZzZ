...
export type TypeMessage = 'CONFIRMATION' | 'RAPPEL_J7' | 'REMERCIEMENT_J2' | 'ANNULATION' | 'RELANCE_PAIEMENT' | 'MANUEL';
export type StatutEnvoi = 'ENVOYE' | 'OUVERT' | 'EN_ATTENTE' | 'ECHEC';
